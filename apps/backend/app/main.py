...
# Configure CORS
cors_origins = settings.BACKEND_CORS_ORIGINS or ["http://localhost:8080"]
app.add_middleware(
    CORSMiddleware,
...
from app.api.v1 import auth, capabilities, documents, search, tags, users, sharing, import_sources, oidc, activity_logs, websocket, chat
